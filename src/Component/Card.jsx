...
function Card({icon, title, content}) {
    ...
    return (
        <div className={cardClasses} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={{backgroundColor: isSmallScreen ? 'var(--tertiary-color)' : 'transparent'}}>
